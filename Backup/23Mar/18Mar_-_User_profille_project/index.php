          ...
          <form enctype="multipart/form-data" method="POST" id="reg_form" class="reg_form">
            ...
            <div class="inside-form-3 mx-3" id="inside-form-3">
              ...
              <div class="my-1">
                ...
                <div class="form-check">
                  <input type="checkbox" id="programming" name="skills[]" class="form-check-input" value="Programming" />
                  <label for="programming" class="form-check-label">Programming</label>
                </div>
                <div class="form-check">
                  <input type="checkbox" id="testing" name="skills[]" class="form-check-input" value="Testing" />
                  <label for="testing" class="form-check-label">Testing</label>
                </div>
                <div class="form-check">
                  <input type="checkbox" id="networking" name="skills[]" class="form-check-input" value="Networking" />
            ...
            <div class="inside-form-4 mx-3" id="inside-form-4">
              ...
              <div class="form-check mb-3">
                <input type="radio" id="yes" name="passport" class="form-check-input" value="YES" />
